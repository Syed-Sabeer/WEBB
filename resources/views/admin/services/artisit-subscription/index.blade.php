...
@section('title', 'Artist Subscription Services')
...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h3>Artist Subscription Services</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Artist Subscription Services</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header card-no-border text-end">
                        <div class="card-header-right-icon">
                            <a class="btn btn-primary f-w-500" href="{{ route('admin.service.artistsubscription.add') }}">
                            ...
                            <div class="recent-table table-responsive custom-scrollbar product-list-table">
                                <table class="table">
                                    ...
                                    <tbody>
                                            ...
                                            <tr class="product-removes">
                                                ...
                                                <td>
                                                    <div class="product-action">
                                                        <a class="square-white" href="{{ route('admin.service.artistsubscription.edit', $service->id) }}">
                                                            <svg>
                                                                <use href="{{ asset('AdminAssets/svg/icon-sprite.svg#edit-content') }}"></use>
                                                            </svg>
                                                        </a>

                                                        <form action="{{ route('admin.service.artistsubscription.destroy', $service->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this service?');" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center">No services found. <a href="{{ route('admin.service.artistsubscription.add') }}">Add your first service</a></td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
