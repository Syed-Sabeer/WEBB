...
@section('title', 'Add Artist Subscription Service')
...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h3>Add Artist Subscription Service</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Artist Subscription Service</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="tab-content custom-input" id="add-product-pills-tabContent">
                                    <div class="tab-pane fade show active" id="detail-product" role="tabpanel" aria-labelledby="detail-product-tab">
                                        <div class="sidebar-body">
                                            <form class="row g-3 common-form" method="POST" action="{{ route('admin.service.artistsubscription.store') }}">
                                                @csrf
                                                <div class="col-md-12">
