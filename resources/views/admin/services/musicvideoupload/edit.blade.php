...
@section('title', 'Edit Music Video Upload Service')
...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h3>Edit Music Video Upload Service</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Music Video Upload Service</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3 common-form" method="POST" action="{{ route('admin.service.musicvideo.update', $service->id) }}">
                            @csrf
                            @method('PUT')
