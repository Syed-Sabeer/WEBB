...
@section('title', 'Add Royalty Collection Service')
...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h3>Add Royalty Collection Service</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Royalty Collection Service</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="tab-content custom-input" id="add-product-pills-tabContent">
                                    <div class="tab-pane fade show active" id="detail-product" role="tabpanel" aria-labelledby="detail-product-tab">
                                        <div class="sidebar-body">
                                            <form class="row g-3 common-form" method="POST" action="{{ route('admin.service.royaltycollection.store') }}">
                                                @csrf
                                                <div class="col-md-12">
                                                    <label class="form-label" for="validationServiceIcon">Service Icon</label>
                                                    <input class="form-control" name="icon" id="validationServiceIcon" type="text" placeholder="Service Icon (e.g., icon class or emoji)" value="{{ old('icon') }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <label class="form-label" for="validationButtonLink">Button Link</label>
                                                    <input class="form-control" name="button_link" id="validationButtonLink" type="text" placeholder="Button Link (e.g., /service/royaltycollection)" value="{{ old('button_link') }}" required>
                                                </div>
                                                <div class="col-md-12">
