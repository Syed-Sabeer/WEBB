                        ...
                        <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                          <li class="nav-item"> <a class="nav-link active" id="detail-product-tab" data-bs-toggle="pill" href="#detail-product" role="tab" aria-controls="detail-product" aria-selected="false">
                              ...
                              <div class="product-tab-content">
                                <h6>Add Privacy Policy Details</h6>
                                <p>Add Privacy Policy name & details</p>
                              </div></a></li>
...
@php
  $isEdit = isset($privacypolicy);
@endphp

<form method="POST" action="{{ $isEdit ? route('admin.privacy-policy.update', $privacypolicy->id) : route('admin.privacy-policy.store') }}">
  @csrf
  @if ($isEdit)
    @method('PUT')
  @endif
  ...
  <div class="col-md-12">
    <label class="form-label" for="validationProductTitle">Privacy Policy Title</label>
    <input
      class="form-control"
      name="title"
  ...
  <div class="col-md-12">
    <label class="form-label">Privacy Policy Description</label>
    <textarea
        id="privacy-policy-description"
      name="description"
      class="form-control"
      rows="6"
    >{!! old('description', $privacypolicy->description ?? '') !!}</textarea>
  </div>
...
@section('script')
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
        CKEDITOR.replace('privacy-policy-description', {
        toolbar: [
