                        ...
                        <div class="tab-content custom-input" id="add-product-pills-tabContent">
                          <div class="tab-pane fade show active" id="detail-product" role="tabpanel" aria-labelledby="detail-product-tab">
                            <div class="sidebar-body">
                              <form class="row g-3 common-form" method="POST" action="{{ route('admin.privacy-policy.store') }}" >
                                @csrf
                                <div class="col-md-12">
...
<div class="col-md-12">
    <label class="form-label">Privacy Policy Description</label>
      <textarea id="privacy-policy-description" name="description" class="form-control" rows="6">{{ old('description') }}</textarea>
</div>
<div class="col-md-6 ">
