...
<div style="max-width:620px;margin:0 auto;padding:28px 16px;"><div style="background:#fff;border-radius:8px;padding:28px;">
    ...
    <p style="margin:0 0 16px;line-height:1.6;">The complete report is attached as an Excel XML spreadsheet. Filter dropdowns are already enabled for record type, date, country, state, city, postal code, area, IP address, and the other columns.</p>
